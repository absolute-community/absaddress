(function (translator) {
	translator.translations["jp"] = {
		...
		"paperlabelabsoluteaddress": "ビットコインアドレス",
		...
		"generatelabelabsoluteaddress": "ビットコインアドレスを生成中...",
		...
		"newaddress": "新アドレス生成",
		"singleprint": "印刷",
		"singlelabelabsoluteaddress": "ビットコインアドレス",
		...
		"singletip4": "<b>残高照会は</b> explorer.absolutecoin.netやblockexplorer.comに行き、ビットコインアドレスを入力してお調べ下さい。",
		"singletip5": "<b>ビットコインを使おう。</b> 送金するには、このページで生成したプライベートキーをexplorer.absolutecoin.netのウォレットや各種パソコン・スマホ端末にあるウォレットアプリなどに取り込んで使えます。しかし、その時点でそのアドレスが取り込んだウォレットの他のアドレスと融合してしまい、この一つのアドレスのバックアップだけじゃビットコインを保管することはできなくなります。取り込み先のウォレットを強いパスワードで暗号化し、バックアップして、安全に扱って下さい。ビットコインの考案者「サトシさん」曰く、「一度作ったウォレットを、空にしたとしても、削除しない方が良い。」(メールアドレスと同じく、いつ昔の友達や親戚から古いアドレス宛にビットコインを送ってくるかわかりませんから。)",
		...
		"bulka1": "以前はビットコインをサイトで受け付けたかったら、「absoluted」というビットコインのシステムサービスをサーバーにアップロードし、サーバー上で実行しなければいけませんでした。しかし、このやり方だとサーバーがハッキングされてしまった場合、プライベートキーも全て持って行かれてしまいます。大量に生成しておいて、ビットコインアドレスだけをサーバーにアップしておけば、プライベートキーを安全な場所に保管できます。",
		...
		"bulklabela2li4": "後は支払いの通知を受けないと注文を通すか否か分かりません。グーグルで「absolute payment notification」と検索したら、SMS、メール、APIなどでビットコインの支払いがあった際教えてくれます。これをコードの中に組み込んで、支払いがあったら注文を通すようにもできます。手動で送金があったかを見る場合、explorer.absolutecoin.netに行き、宛先のアドレスを入力すれば、取引履歴から送金の事実を確認できます。大体送金の30秒後に表示され、10分～1時間の間に「確認」されます。",
		...
		"brainlabelabsoluteaddress": "ビットコインアドレス",
		...
		"vanitylabelabsoluteaddress": "カスタムビットコインアドレス",
		"vanitylabelnotesabsoluteaddress": "ご希望された頭文字を持ったアドレスになっています。",
		...
		"detaillabelabsoluteaddress": "ビットコインアドレス",
		"detaillabelabsoluteaddresscomp": "ビットコインアドレス(圧縮)",
