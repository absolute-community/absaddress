(function (translator) {
	translator.translations["ru"] = {
		...
		"paperlabelabsoluteaddress": "Адрес Absolute кошелька:",
		...
		"generatelabelabsoluteaddress": "Генерация Биткоин адреса...",
		...
		"singlelabelabsoluteaddress": "Адрес Биткоин кошелька",
		...
		"brainlabelabsoluteaddress": "Адрес Биткоин кошелька:",
		...
		"vanitylabelabsoluteaddress": "Адрес Биткоин кошелька:",
		"vanitylabelnotesabsoluteaddress": "Это Ваш новый адрес с префиксом.",
		...
		"detaillabelnote2": "Приложение Absolute версии 0.6 и выше хранит ключи в сжатом формате. Это приложение также поддерживает импорт и экспорт приватных ключей командами importprivkey/dumpprivkey. Формат экспортированного ключа определяется кошельком, который сгенерировал адрес Биткоин.",
		"detaillabelabsoluteaddress": "Адрес Биткоин кошелька",
		"detaillabelabsoluteaddresscomp": "Короткий адрес Биткоин кошелька",
